<?php
    ...
    $valuesBeforeSotr = array('name' => 'Buzz Lightyear', 'email_address' => 'buzz@starcommand.gal', 'age' => 32, 'smarts' => 'some');
    if($_POST["submitted"]){
...
<form action="UserSorting.php" method="post">
    ...
    <p>
        Values unsort (befor sort):
    </p>
    <ul>
        <?php
            foreach($valuesBeforeSotr as $key=>$value) {
